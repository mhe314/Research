...
st.text('3. Click on the checkbox below to display the plot you want to view. You can select more \n   than one at a time')
st.text('4. Once you select a plot, make sure to give the app a few moments to load the plot')
st.text('5. Click the last checkbox to display the audio bar for the generated guitar key sound. \n   Press the play button on the audio bar to hear the generated guitar sound!')
st.text('')
st.text('')
