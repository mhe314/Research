...
st.text('5. Click the last checkbox to display the audio bar for the generated guitar key sound. Press the play button on the audio bar to hear the generated guitar sound!')
st.text('')
st.text('')
