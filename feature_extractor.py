...
#             horizontalalignment='left')
            plt.annotate('Dominant Frequency', xy=(xmax,ymax), xytext=(xmax+200, ymax-50), arrowprops=dict(facecolor='black'),
            horizontalalignment='left', verticalalignment='top', shrink=5)
